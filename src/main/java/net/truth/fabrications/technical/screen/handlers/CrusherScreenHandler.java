package net.truth.fabrications.technical.screen.handlers;
...
import net.truth.fabrications.technical.block.entity.CrusherBlockEntity;
...
public class CrusherScreenHandler extends ScreenHandler {
    ...
    public CrusherScreenHandler(int syncId, PlayerInventory playerInventory,
        ...
        this.addSlot(new Slot(inventory, 2, 98, 21));
        this.addSlot(new Slot(inventory, 3, 116, 21));
        this.addSlot(new Slot(inventory, 4, 80, 45));
        this.addSlot(new Slot(inventory, 5, 98, 45));
        this.addSlot(new Slot(inventory, 6, 152, 63));
